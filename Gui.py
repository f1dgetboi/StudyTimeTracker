...
class buy_frame():
    def __init__(self,x,y,color,price,name,photo): #photo size is going to be 375 x 300
        self.name= name
        self.width = 400
        self.height = 400
        self.x = x
    ...
    def draw(self):
        ...
        create_center_text(DEFAULT_FONT,40,(0,0,0),self.x + self.width /2  ,self.y + self.height- 60 ,self.name)
